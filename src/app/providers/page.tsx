  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      if (editingId) {
        ...
        } else if (form.type !== "SUB2API_KEY" && !form.apiKey.trim()) {
            ...
            <form onSubmit={onSubmit} className="space-y-3">
              ...
              <div className="space-y-1.5">
                ...
                >
                  ...
                  <option value="SUB2API_KEY">Sub2API Key 模式</option>
                ...
                <CardContent className="flex flex-wrap items-start justify-between gap-4 p-5">
                  <div className="min-w-0 space-y-1">
                    ...
                    <p className="text-xs text-secondary font-data">
                      {p.type === "SUB2API_KEY" ? (
                        <>
                          Sub2API Key 模式 · 成本 {formatRmb(p.discountRate)}/面值 · 预警{" "}
                  ...
                  <div className="flex flex-wrap justify-end gap-2">
                    ...
                    {(p.type === "SUB2API" || p.type === "SUB2API_KEY") && !p.retiredAt && (
                      <Link
                        href={`/providers/${p.id}`}
                        aria-label="密钥与分组"
                        title="密钥与分组管理"
